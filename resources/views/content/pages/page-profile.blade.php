  ...
  <div class="row">
    <div class="col-12">
      <div class="card profile-header mb-2">
        ...
        <img
          class="card-img-top"
          src="{{asset('images/banner/20360677.jpg')}}"
        ...
        <div class="position-relative">
          ...
          <div class="profile-img-container d-flex align-items-center">
            <div class="profile-img">
              <img
                src="{{asset('images/portrait/small/wilsonooi.jpg')}}"
              ...
              <li class="timeline-item">
                ...
                <div class="timeline-event">
                  ...
                  <div class="media align-items-center">
                    ...
                    <img class="mr-1" src="{{asset('images/icons/pdf.png')}}" alt="My Resume" height="23" />
            ...
            <div class="row">
              <div class="col-md-4 col-6 profile-latest-img">
                <a href="javascript:void(0)">
                  <img
                    src="{{asset('images/trip/10551011_10152378014998311_8606317335599710265_n.jpg')}}"
              ...
              <div class="col-md-4 col-6 profile-latest-img">
                <a href="javascript:void(0)">
                  <img
                    src="{{asset('images/trip/46348684_10157130211163311_4572419069470310400_n.jpg')}}"
                    class="img-fluid rounded"
                    alt="avatar img"
                  />
                </a>
              ...
              <div class="col-md-4 col-6 profile-latest-img">
                <a href="javascript:void(0)">
                  <img
                    src="{{asset('images/trip/DSC_0033.JPG')}}"
                    class="img-fluid rounded"
                    alt="avatar img"
                  />
                </a>
              ...
              <div class="col-md-4 col-6 profile-latest-img">
                <a href="javascript:void(0)">
                  <img
                    src="{{asset('images/trip/DSC_0034.JPG')}}"
                    class="img-fluid rounded"
                    alt="avatar img"
                  />
                </a>
              ...
              <div class="col-md-4 col-6 profile-latest-img">
                <a href="javascript:void(0)">
                  <img
                    src="{{asset('images/trip/P1020757.JPG')}}"
                    class="img-fluid rounded"
                    alt="avatar img"
                  />
                </a>
              ...
              <div class="col-md-4 col-6 profile-latest-img">
                <a href="javascript:void(0)">
                  <img
                    src="{{asset('images/trip/DSC_0277.JPG')}}"
                    class="img-fluid rounded"
                    alt="avatar img"
                  />
                </a>
              ...
              <div class="col-md-4 col-6 profile-latest-img">
                <a href="javascript:void(0)">
                  <img
                    src="{{asset('images/trip/img1537580358519.jpg')}}"
                    class="img-fluid rounded"
                    alt="avatar img"
                  />
                </a>
              ...
              <div class="col-md-4 col-6 profile-latest-img">
                <a href="javascript:void(0)">
                  <img
                    src="{{asset('images/trip/img1537580270246.jpg')}}"
                    class="img-fluid rounded"
                    alt="avatar img"
                  />
                </a>
              ...
              <div class="col-md-4 col-6 profile-latest-img">
                <a href="javascript:void(0)">
                  <img
                    src="{{asset('images/trip/DSC_0439.JPG')}}"
                    class="img-fluid rounded"
                    alt="avatar img"
                  />
                </a>
      ...
      <div class="col-lg-8 col-12 order-2 order-lg-2">
              ...
              <li class="timeline-item">
                ...
                <div class="timeline-event">
                  ...
                  <div class="avatar-group">
                    ...
                    >
                      <img
                        src="{{asset('https://2fasvg.github.io/assets/img/logo/cloudways.com/cloudways.com.svg')}}"
                        alt="Avatar"
                        width="33"
                        height="33"
                      />
                    ...
                    >
                      <img
                        src="{{asset('https://2fasvg.github.io/assets/img/logo/cpanel.net/cpanel.net.svg')}}"
                        alt="Avatar"
                        width="33"
                        height="33"
                      />
                    ...
                    >
                      <img
                        src="{{asset('https://2fasvg.github.io/assets/img/logo/wasabi.com/wasabi.com.svg')}}"
                        alt="Avatar"
                        width="33"
                        height="33"
                      />
                    ...
                    >
                      <img
                        src="{{asset('https://2fasvg.github.io/assets/img/logo/clickup.com/clickup.com.svg')}}"
                        alt="Avatar"
                        width="33"
                        height="33"
                      />
                    ...
                    >
                      <img
                        src="{{asset('https://2fasvg.github.io/assets/img/logo/gitlab.com/gitlab.com.svg')}}"
                        alt="Avatar"
                        width="33"
                        height="33"
                      />
                    ...
                    >
                      <img
                        src="{{asset('https://2fasvg.github.io/assets/img/logo/github.com/github.com.svg')}}"
                        alt="Avatar"
                        width="33"
                        height="33"
                      />
                    ...
                    >
                      <img
                        src="{{asset('https://2fasvg.github.io/assets/img/logo/cloudflare.com/cloudflare.com.svg')}}"
                        alt="Avatar"
                        width="33"
                        height="33"
                      />
              ...
              <li class="timeline-item">
                ...
                <div class="timeline-event">
                  ...
                  <div class="avatar-group">
                    ...
                    >
                      <img
                        src="{{asset('https://2fasvg.github.io/assets/img/logo/onesignal.com/onesignal.com.svg')}}"
                        alt="Avatar"
                        width="33"
                        height="33"
                      />
                    ...
                    >
                      <img
                        src="{{asset('https://2fasvg.github.io/assets/img/logo/mailchimp.com/mailchimp.com.svg')}}"
                        alt="Avatar"
                        width="33"
                        height="33"
                      />
                    ...
                    >
                      <img
                        src="{{asset('http://siliconangle.com/files/2013/09/mariadb-logo.png')}}"
                        alt="Avatar"
                        width="33"
                        height="33"
                      />
                    ...
                    >
                      <img
                        src="{{asset('https://zohowebstatic.com/sites/default/files/ogimage/zoho-logo.png')}}"
                        alt="Avatar"
                        width="33"
                        height="33"
                      />
                    ...
                    >
                      <img
                        src="{{asset('https://2fasvg.github.io/assets/img/logo/wordpress.com/wordpress.com.svg')}}"
                        alt="Avatar"
                        width="33"
                        height="33"
                      />
                    ...
                    >
                      <img
                        src="{{asset('https://2fasvg.github.io/assets/img/logo/woocommerce.com/woocommerce.com.svg')}}"
                        alt="Avatar"
                        width="33"
                        height="33"
                      />
              ...
              <li class="timeline-item">
                ...
                <div class="timeline-event">
                  ...
                  <div class="avatar-group">
                    ...
                    >
                      <img
                        src="{{asset('https://i.pinimg.com/564x/63/3f/19/633f19cd04671379b2257db894167c36.jpg')}}"
                        alt="Avatar"
                        width="33"
                        height="33"
                      />
                    ...
                    >
                      <img
                        src="{{asset('https://styles.redditmedia.com/t5_2qm6k/styles/communityIcon_dhjr6guc03x51.png?width=256&s=3e825b7205c7f497d4695028e358d26ee359f84b')}}"
                        alt="Avatar"
                        width="33"
                        height="33"
                      />
                    ...
                    >
                      <img
                        src="{{asset('https://2fasvg.github.io/assets/img/logo/joomla.org/joomla.org.svg')}}"
                        alt="Avatar"
                        width="33"
                        height="33"
                      />
              ...
              <li class="timeline-item">
                ...
                <div class="timeline-event">
                  ...
                  <div class="avatar-group">
                    ...
                    >
                      <img
                        src="{{asset('https://www.pcsintl.com/wp-content/uploads/2019/04/winSer2008R2Std_grande-300x300.png')}}"
                        alt="Avatar"
                        width="33"
                        height="33"
                      />
        ...
        <div class="card">
          <div class="card-body">
            ...
            <img
              ...
              src="{{asset('images/banner/familytrip2018.jpg')}}"
              alt="avatar img"
            />
            <!--/ post img -->
        ...
        <div class="card">
          <div class="card-body">
            ...
            <img
              class="img-fluid rounded mb-75"
              src="{{asset('images/trip/DSC_0051.JPG')}}"
              alt="avatar img"
            />
            <!--/ post img -->
