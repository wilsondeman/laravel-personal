...
class TableController extends Controller
{
  ...
  // Datatable Basic
  public function bitwallet_q1()
  {
    $breadcrumbs = [['link' => "/", 'name' => "Home"], ['link' => "javascript:void(0)", 'name' => "Datatable"], ['name' => "Advanced"]];
    return view('/content/table/table-datatable/bitwallet-q1', ['breadcrumbs' => $breadcrumbs]);
  }
